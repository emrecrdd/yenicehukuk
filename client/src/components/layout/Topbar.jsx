...
const Topbar = ({ onMenuClick }) => {
  ...
  // ✅ Hook'lar - refetchInterval ve refetchOnWindowFocus zaten içinde
  ...
  // ======================================================
  // SOCKET - Bildirimleri dinle
  // ======================================================

  useEffect(() => {
    const handleNotification = (data) => {
      // ✅ Bildirim sayısını ve listeyi güncelle
      refetchUnread();
  ...
  // ======================================================
  // DİŞARI TIKLAMA - Dropdown'ları kapat
  // ======================================================
